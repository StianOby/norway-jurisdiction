...
Generated 2026-09-17T13:05:44+00:00. Simplification: arcs 100.0 m, coast 300.0 m, islands ≥ 3.0 km². Exempt: baselines (layer 0); agreed delimitation lines (layers 8, 10); other states' 200 nm limits (layer 11); continental-shelf outer limit (layer 9).
...
| `continental-shelf` | all | seabed, subsoil | 1322 | Kartverket Norges maritime grenser (Geonorge GML EPSG:4258) - Kontinentalsokkel: Norges kontinentalsokkel **+contestedExtent** (805 v.) |
...
**Zone polygon vertices:** 32396 (SPEC §8 target 35000); zones.json 934 KB.
...
- WARN: janmayen-fisheries-zone [no]: no citations
- WARN: janmayen-fisheries-zone [no]: summary not shipped (status: missing)
- WARN: janmayen-fisheries-zone [en]: no citations
- WARN: janmayen-fisheries-zone [en]: summary not shipped (status: missing)
...
- citations: 76 (every one with a quote from a fetched document)
